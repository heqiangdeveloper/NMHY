...
public class OilReq {
    ...
    //新增 燃油申请 主表
    public OilReq(String applyTime, String bargeName, int voyagePlanId, String applyReason, int
            owerCompId, int supplierId, String paymentMethod, String currency, String ifPrepaid,
                  double pepaidAmount) {
